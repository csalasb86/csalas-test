...
[
  {id: 1, name: 'Tom Araya', phone: '666666666', cities: ['Santiago', 'Vitacura'], max_stops_amount: 10},
...
puts "Cargando Rutas"
[
  {id: 1, starts_at: DateTime.parse("#{Date.today} 09:00:00"), ends_at: DateTime.parse("#{Date.today} 10:00:00"), load_type_id: LoadType::GENERAL, load_sum: 50, cities: ['Santiago'], stops_amount: 2},
  {id: 2, starts_at: DateTime.parse("#{Date.today} 09:00:00"), ends_at: DateTime.parse("#{Date.today} 11:00:00"), load_type_id: LoadType::GENERAL, load_sum: 100, cities: ['Huechuraba'], stops_amount: 5},
  {id: 3, starts_at: DateTime.parse("#{Date.today} 10:35:00"), ends_at: DateTime.parse("#{Date.today} 13:24:00"), load_type_id: LoadType::GENERAL, load_sum: 460, cities: ['Santiago','Las Condes'], stops_amount: 4},
  {id: 4, starts_at: DateTime.parse("#{Date.today} 12:58:00"), ends_at: DateTime.parse("#{Date.today} 14:00:00"), load_type_id: LoadType::REFRIGERADA, load_sum: 500, cities: ['Maipu'], stops_amount: 10},
  {id: 5, starts_at: DateTime.parse("#{Date.today} 08:30:00"), ends_at: DateTime.parse("#{Date.today} 18:20:00"), load_type_id: LoadType::REFRIGERADA, load_sum: 1000, cities: ['Providencia'], stops_amount: 1},
].each do | attrs |
